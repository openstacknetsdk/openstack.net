namespace OpenStack.Services.Identity.V2
{
    ...
    public static class ListExtensionsApiCallExtensions
    {
        ...
        /// specified <paramref name="limit"/>.</returns>
        ...
        public static ListExtensionsApiCall WithLimit(this ListExtensionsApiCall apiCall, int? limit)
        {
            if (apiCall == null)
            ...
            if (!limit.HasValue)
                ...
                apiCall.RequestMessage.RequestUri = UriUtility.SetQueryParameter(uri, "limit", limit.ToString());
        ...
        /// </summary>
        /// <remarks>
        /// <para>This method simplifies the use of <see cref="WithLimit(ListExtensionsApiCall, int?)"/> in
        ...
        /// <exception cref="InvalidOperationException">If the HTTP API call has already been sent.</exception>
        /// <seealso href="http://docs.openstack.org/api/openstack-identity-service/2.0/content/Paginated_Collections-d1e325.html">Paginated collections (OpenStack Identity API v2.0 Reference)</seealso>
        public static Task<ListExtensionsApiCall> WithLimit(this Task<ListExtensionsApiCall> apiCall, int? limit)
        {
            return apiCall.Select(task => apiCall.Result.WithLimit(limit));
        }

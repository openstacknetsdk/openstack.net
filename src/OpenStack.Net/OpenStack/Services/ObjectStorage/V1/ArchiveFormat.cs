namespace OpenStack.Services.ObjectStorage.V1
{
    ...
    /// </summary>
    /// <remarks>
    /// This class functions as a strongly-typed enumeration of known archive types, with added support for unknown
    /// types returned or supported by a server extension.
    /// </remarks>
    ...
    {
        private static readonly ConcurrentDictionary<string, ArchiveFormat> _values =
        ...
        public static ArchiveFormat FromName(string name)
        {
            ...
            return _values.GetOrAdd(name, i => new ArchiveFormat(i));
        }

...
namespace OpenStack.Compute.v2_1
{
    ...
    public class ServerStatus : StringEnumeration
    {
        ...
        /// </summary>
        public static readonly ServerStatus Active = new ServerStatus("ACTIVE");

        /// <summary>
        /// The server has not finished the original build process.
        /// </summary>
        public static readonly ServerStatus Building = new ServerStatus("BUILDING");

        /// <summary>
        /// The server is permanently deleted.
        /// </summary>
        public static readonly ServerStatus Deleted = new ServerStatus("DELETED");
        ...
        /// </summary>
        public static readonly ServerStatus HardReboot = new ServerStatus("HARD_REBOOT");

        /// <summary>
        /// The server is being migrated to a new host.
        /// </summary>
        public static readonly ServerStatus Migrating = new ServerStatus("MIGRATING");

        /// <summary>
        /// The Password is being reset on the server.
        /// </summary>
        public static readonly ServerStatus Password = new ServerStatus("PASSWORD");

        /// <summary>
        /// In a Paused state, the state of the server is stored in RAM.A Paused server continues to run in frozen state.
        /// </summary>
        public static readonly ServerStatus Paused = new ServerStatus("PAUSED");

        /// <summary>
        /// The server is in a soft Reboot state. A Reboot command was passed to the operating system.
        /// </summary>
        public static readonly ServerStatus Reboot = new ServerStatus("REBOOT");

        /// <summary>
        /// The server is currently being rebuilt from an image.
        /// </summary>
        public static readonly ServerStatus Rebuild = new ServerStatus("REBUILD");
        ...
        /// </summary>
        public static readonly ServerStatus Resized = new ServerStatus("RESIZED");
        ...
        /// </summary>
        public static readonly ServerStatus RevertResize = new ServerStatus("REVERT_RESIZE");

        /// <summary>
        /// The server is marked as deleted but the disk images are still available to restore.
        /// </summary>
        public static readonly ServerStatus SoftDeleted = new ServerStatus("SOFT_DELETED");
        ...
        /// </summary>
        public static readonly ServerStatus Suspended = new ServerStatus("SUSPENDED");

        /// <summary>
        /// The state of the server is unknown.Contact your cloud provider.
        /// </summary>
        public static readonly ServerStatus Unknown = new ServerStatus("UNKNOWN");

        /// <summary>
        /// System is awaiting confirmation that the server is operational after a move or resize.
        /// </summary>
        public static readonly ServerStatus VerifyResize = new ServerStatus("VERIFY_RESIZE");

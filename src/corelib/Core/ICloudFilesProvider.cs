...
namespace net.openstack.Core
{
    public interface ICloudFilesProvider
    {
        ...
        IEnumerable<Container> ListContainers(int? limit = null, string markerId = null, string markerEnd = null, string region = null, bool useInternalUrl = false, CloudIdentity identity = null);
        ...
        IEnumerable<ContainerObject> ListObjects(string container, int? limit = null, string markerId = null, string markerEnd = null, string region = null, bool useInternalUrl = false, CloudIdentity identity = null);
        ...
        ObjectStore DeleteObject(string container, string objectNmae, Dictionary<string, string> headers = null, string region = null, bool useInternalUrl = false, CloudIdentity identity = null);

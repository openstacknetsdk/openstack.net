...
namespace net.openstack.Core.Providers
{
    ...
    public interface IComputeProvider
    {
        ...
        /// <param name="markerId">The <see cref="ServerBase.Id"/> of the last item in the previous list. Used for <see href="http://docs.openstack.org/api/openstack-compute/2/content/Paginated_Collections-d1e664.html">pagination</see>. If the value is <c>null</c>, the list starts at the beginning.</param>
        ...
        /// </remarks>
        /// <param name="server">Filters the list of images by server. This is specified as a server ID (see <see cref="ServerBase.Id"/>) or a full URL. If the value is <c>null</c>, the results are not filtered by ID.</param>
        ...
        /// <param name="markerId">The <see cref="SimpleServerImage.Id"/> of the last item in the previous list. Used for <see href="http://docs.openstack.org/api/openstack-compute/2/content/Paginated_Collections-d1e664.html">pagination</see>. If the value is <c>null</c>, the results start at the beginning.</param>
        /// <param name="limit">Indicates the maximum number of items to return. Used for <see href="http://docs.openstack.org/api/openstack-compute/2/content/Paginated_Collections-d1e664.html">pagination</see>. If the value is <c>null</c>, a provider-specific default value is used.</param>
        ...
        /// <exception cref="ArgumentNullException">If <paramref name="imageId"/> is <c>null</c>.</exception>

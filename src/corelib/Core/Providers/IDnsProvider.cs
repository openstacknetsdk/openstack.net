...
namespace net.openstack.Core.Providers
{
    ...
    public interface IDnsProvider
    {
        ...
        /// <returns>IEnumerable of <see cref="net.openstack.Core.Domain.Domain"/></returns>
        IEnumerable<Core.Domain.Domain> ListDomains(int? limit = null, int? offset = null, string name = null, CloudIdentity identity = null);
        ...
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>
        /// <returns><see cref="net.openstack.Core.Domain.Domain"/></returns>
        Core.Domain.Domain ListDomainDetails(int domainId, int? limit = null, int? offset = null, bool showRecords = true, bool showSubdomains = true, CloudIdentity identity = null);

        /// <summary>
        /// Creates new domains with the configuration defined by the request.
        /// </summary>
        /// <param name="domains">IEnumerable of <see cref="net.openstack.Core.Domain.Domain"/> to create.</param>
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>
        void CreateDomains(IEnumerable<Core.Domain.Domain> domains, CloudIdentity identity = null);
        ...
        /// </summary>
        /// <param name="domains">IEnumerable of <see cref="net.openstack.Core.Domain.Domain"/> to modify.</param>
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>
        void ModifyDomains(IEnumerable<Core.Domain.Domain> domains, CloudIdentity identity = null);
        ...
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>
        /// <returns>IEnumerable of <see cref="net.openstack.Core.Domain.Domain"/></returns>
        IEnumerable<Core.Domain.Domain> ListSubdomains(int domainId, int? limit = null, int? offset = null, CloudIdentity identity = null);
        ...
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>
        /// <returns>IEnumerable of <see cref="net.openstack.Core.Domain.Record"/></returns>
        ...
        /// </summary>
        /// <param name="domainId">The Domain Id.</param>
        /// <param name="records">IEnumerable of <see cref="net.openstack.Core.Domain.Domain"/> to add.</param>
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>
        ...
        /// </summary>
        /// <param name="domainId">The Domain Id.</param>
        /// <param name="records">IEnumerable of <see cref="net.openstack.Core.Domain.Domain"/> to modify.</param>
        /// <param name="identity">The users Cloud Identity. <see cref="CloudIdentity"/> <remarks>If not specified, the default identity given in the constructor will be used.</remarks></param>

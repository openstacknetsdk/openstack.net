namespace net.openstack.Providers.Rackspace.Objects.Monitoring
{
    ...
    public class ImapBannerCheckDetails : SecureConnectionCheckDetails
    {
        ...
        /// </summary>
        /// <param name="port">The port to use for connecting to the remote service. If this value is <c>null</c>, the default port (143) for the associated service should be used.</param>

namespace net.openstack.Providers.Rackspace.Objects.Monitoring
{
    ...
    public class Pop3CheckDetails : SecureConnectionCheckDetails
    {
        ...
        /// </summary>
        /// <param name="port">The port to use for connecting to the remote service. If this value is <c>null</c>, the default port (110) for the associated service should be used.</param>

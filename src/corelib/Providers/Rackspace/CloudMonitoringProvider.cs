...
namespace net.openstack.Providers.Rackspace
{
    ...
    #region Account
        ...
        #region Get Account
        public Account GetAccountInformation(string region = null, CloudIdentity identity = null)
        {
            var urlPath = new Uri(string.Format("{0}/account", GetServiceEndpoint(identity, region)));
            var response = ExecuteRESTRequest<Account>(identity, urlPath, HttpMethod.GET);

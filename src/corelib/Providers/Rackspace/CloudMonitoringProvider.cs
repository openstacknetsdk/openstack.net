...
namespace net.openstack.Providers.Rackspace
{
    ...
    #region Account
        ...
        #region Get Limits
        public Limit GetAccountLimits(string region = null, CloudIdentity identity = null)
        {
            var urlPath = new Uri(string.Format("{0}/limits", GetServiceEndpoint(identity, region)));
            var response = ExecuteRESTRequest<Limit>(identity, urlPath, HttpMethod.GET);
